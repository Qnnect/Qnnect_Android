...
class UserQuestionListHolderPage internal constructor(itemView: View, var context: Context, var a_itemClickListener: UserQuestionListAdapter.OnItemClickEventListener) : RecyclerView.ViewHolder(itemView) {
